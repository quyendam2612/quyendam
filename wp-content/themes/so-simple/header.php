...
<html <?php language_attributes(); ?>>
	<head>
		...
		<?php if(get_sosimpleoption('favicon')) : ?>
			<link rel="icon" href="<?php echo sanitize_text_field(get_sosimpleoption('favicon')); ?>" type="image/x-icon">
		<?php else: ?>
		...
		<div id="page" class="hfeed site">
			...
			<header class="site-header">
				...
				<div class="site-logo">
					...
					<?php if($logo) : ?>
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="logo" rel="home"><img src="<?php echo sanitize_text_field($logo); ?>" class="logo"></a>
