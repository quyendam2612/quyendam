 ...
 */
function sosimplescripts_styles() {
	wp_enqueue_style( 'so-simple-75-fonts', sosimplefonts_url(), array(), null );
	wp_enqueue_script( 'plugins', get_template_directory_uri() . '/assets/js/plugins-min.js', array(), sosimpleversion_id(), true );
...
add_action( 'wp_enqueue_scripts', 'sosimplescripts_styles' );
